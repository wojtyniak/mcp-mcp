...
**Integration Tests**: Set `MCP_MCP_TEST_GITHUB_INTEGRATION=1` to test real GitHub downloads and verify the complete first-user onboarding experience. These tests ensure users get fast startup (< 5 seconds) with 1,672+ servers.

## Roadmap

### Current Status: MVP Complete ✅
- ✅ Multi-source discovery (3 curated sources, 1,672+ unique servers)
